            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">All Moofee</a></li>
						<li class="breadcrumb-item active"><a href="javascript:void(0)">{{$moofee->title}}</a></li>
					</ol>
						<a class="float-right btn btn-warning btn-sm" href="{{route('all_moofee')}}"><i class="fa fa-arrow-left"></i> Back</a>
                </div>
                <!-- row -->
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Moofee's Submissions</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{date('M d,Y @h:i a',strtotime($moofee->created_at))}}</td>
											</tr>
										</tbody>
									</table>
								</div>
                                    ...
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{$moofee->user->fname}} {{$moofee->user->lname}}</td>
											</tr>
                                            <tr>
                                                <th>Email</th>
                                                <td>{{$moofee->user->email}}</td>
											</tr>
                                            <tr>
                                                <th>Phone</th>
                                                <td>{{$moofee->user->phone}}</td>
											</tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Video</th>
                                                <td><a target="_blank" href="{{asset('upload/Moofee/'.$moofee->media()->first()->path)}}" class="btn btn-primary btn-sm">View Video</a></td>
											</tr>
                                        </tbody>
                                    </table>
                                </div>
