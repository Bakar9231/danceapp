            ...
            <div class="container-fluid">
                ...
                <div class="page-titles">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">EOI's</a></li>
					...
					<div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <h4 class="card-title">EOI's Records</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													...
													<div class="d-flex">
														...
														<a href="{{route('get_cmp',$val->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
