            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">All CMP</a></li>
					</ol>
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">CMP's Submissions</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{date('M d,Y @h:i a',strtotime($eoi->created_at))}}</td>
											</tr>
										</tbody>
									</table>
								</div>
                                    ...
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{$eoi->user->fname}} {{$eoi->user->lname}}</td>
											</tr>
                                            <tr>
                                                <th>Email</th>
                                                <td>{{$eoi->user->email}}</td>
											</tr>
                                            <tr>
                                                <th>Phone</th>
                                                <td>{{$eoi->user->phone}}</td>
											</tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Video</th>
                                                <td><a target="_blank" href="{{asset('upload/EOI/'.$eoi->media()->first()->path)}}" class="btn btn-primary btn-sm">View Video</a></td>
											</tr>
                                        </tbody>
                                    </table>
                                </div>
